...
export const SparklesIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2.5l1.06 2.65L16 6l-2.65 1.06L12 9.71 10.94 7.06 8.29 6l2.65-1.06L12 2.5zm-4.24 6.27L6 10.53l-1.76-1.76L2.5 10l1.76 1.76L6 13.53l1.76-1.76L9.52 10l-1.76-1.76zM18 10.53l-1.76-1.76L14.5 10l1.76 1.76L18 13.53l1.76-1.76L21.5 10l-1.76-1.76L18 10.53zm-6 8.18l-1.06 2.65L8.29 20l2.65 1.06L12 23.71l1.06-2.65L15.71 20l-2.65-1.06L12 16.29z"/>
    </svg>
);
